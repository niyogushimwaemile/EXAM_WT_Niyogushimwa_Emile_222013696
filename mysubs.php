<?php
  ...
  $sel = mysqli_query($con, "SELECT * FROM products JOIN subscriptions ON products.ProductID=subscriptions.productID JOIN customer ON customer.CustomerID=subscriptions.customerID WHERE email='$email'");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="card-body">
              ...
              <table class="table table-borderless datatable table-striped">
                ...
                <tbody>
                  ...
                  ?>
                  <tr>
                    <th scope="row"><img src=<?php echo $row['photo']?> alt="Photo" width="60" height="60"></th>
                    <td class="text-primary fw-bold"><?php echo $row['prod_name']?></td>
