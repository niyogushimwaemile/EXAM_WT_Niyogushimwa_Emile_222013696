                ...
                <div class="card-body pb-0">
                  <h5 class="card-title">My subscriptions </h5>
                    <?php
                      ...
                      $sel = mysqli_query($con, "SELECT count(subscriptionID) AS subs, photo, prod_name, price, products.ProductID, vendor_id FROM subscriptions JOIN products ON subscriptions.productID=products.ProductID WHERE products.vendor_id=$id GROUP BY products.ProductID ORDER BY subs DESC");
                      ?>
